...
#
#  Bumpding to 2.1.6 for Fastlane tools updates and Xcode 8.2 compatibility (2016/12/21:AB)
...
Pod::Spec.new do |s|
  ...
  # Existing apps should be using updated hAPITracker.podspec that is pinned this version of the podspec.
